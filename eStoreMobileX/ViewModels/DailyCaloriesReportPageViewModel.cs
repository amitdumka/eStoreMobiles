...
namespace eStoreMobileX.ViewModels
{
    ...
    public class DailyCaloriesReportPageViewModel : BaseViewModel
    {
        #region Field
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="DailyCaloriesReportPageViewModel" /> class.
        /// </summary>
        public DailyCaloriesReportPageViewModel()
        {
