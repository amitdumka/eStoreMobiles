...
namespace eStoreMobileX.ViewModels
{
    ...
    public class HealthCarePageViewModel : BaseViewModel
    {
        #region Field
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="HealthCarePageViewModel" /> class.
        /// </summary>
        public HealthCarePageViewModel()
        {
            this.GetChartData();
