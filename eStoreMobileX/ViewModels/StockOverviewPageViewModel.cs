...
namespace eStoreMobileX.ViewModels
{
    ...
    public class StockOverviewPageViewModel : BaseViewModel
    {
        #region Field
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="StockOverviewPageViewModel" /> class.
        /// </summary>
        public StockOverviewPageViewModel()
        {
            this.GetChartData();
