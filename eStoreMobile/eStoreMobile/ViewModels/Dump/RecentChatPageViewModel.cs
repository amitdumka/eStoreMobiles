...
namespace eStoreMobile.ViewModels
{
    ...
    [DataContract]
    public class RecentChatPageViewModel : BaseViewModel
    {
        #region Fields

        private static RecentChatPageViewModel recentChatViewModel;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RecentChatPageViewModel" /> class.
        /// </summary>
        public RecentChatPageViewModel()
        {
        }
        ...
        /// </summary>
        public static RecentChatPageViewModel BindingContext =>
            recentChatViewModel = PopulateData<RecentChatPageViewModel> ("chat.json");
