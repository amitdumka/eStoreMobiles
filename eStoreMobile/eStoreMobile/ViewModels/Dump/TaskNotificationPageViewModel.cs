...
namespace eStoreMobile.ViewModels
{
    ...
    [DataContract]
    public class TaskNotificationPageViewModel : BaseViewModel
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="TaskNotificationPageViewModel"/> class.
        /// </summary>
        public TaskNotificationPageViewModel()
        {
        }
